...
df_ = pd.read_csv("odev/datasets/armut_data.csv")
df = df_.copy()
df.head()
df.info()
df.shape
...
new_df = new_df + 1 #NaN'ları 0 idli kullanıcıdan ayırmak için başta 0 olanlar +1 eklemesi yapılır.
...
apriori_df = apriori(new_df,                         #birlikte görülme olasılıkları
                     min_support=0.01,
                     use_colnames=True,
                     low_memory=True)

rules = association_rules(apriori_df,                #birlikte görülme kuralları
                          metric="support",
                          min_threshold=0.01)
...
#Out[68]: ['22_0', '25_0', '15_1', '13_11', '38_4']

# HİZMET ÖNERİSİ: "2_0" hizmetini alan kullanıcıya sırasıyla  ['22_0', '25_0', '15_1', '13_11', '38_4'] ürünleri tavsiye edilebilir.
# Lift'e göre sıralandığı için "2_0" hizmetini alan kullanıcının '22_0' hizmetini alma ihtimali en yüksektir. O nedenle bu sırayla öneri yapılabilir.
